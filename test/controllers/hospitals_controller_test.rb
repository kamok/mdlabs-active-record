...
class HospitalsControllerTest < ActionController::TestCase
  ...
  test "should create hospital" do
    assert_difference('Hospital.count') do
      post :create, hospital: { hospital_address: @hospital.hospital_address, hospital_name: @hospital.hospital_name }
    end
  ...
  test "should update hospital" do
    patch :update, id: @hospital, hospital: { hospital_address: @hospital.hospital_address, hospital_name: @hospital.hospital_name }
    assert_redirected_to hospital_path(assigns(:hospital))
  end
